...
public partial class _Default : System.Web.UI.Page
{
    ...
    int day, hour, min;
    string ndate, ntime, Enrollment_No;
    ...
    public void load_notification()
    {
        int i;
        con.Open();
        SqlCommand cmd = new SqlCommand("select * from Notice where Enrollment_No ='"+ Enrollment_No +"' order by Notice_Date desc", con);
    ...
    {
            Response.Redirect("InboxDesc?PNotice=" + nid + "");
    }
