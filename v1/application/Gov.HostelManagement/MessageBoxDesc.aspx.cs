...
public partial class Default2 : System.Web.UI.Page
{
    ...
    {
        MessageID = Request.QueryString["Message"];
        if (MessageID == "" || MessageID == null)
            Response.Redirect("MessageBox");
        fetch_desc();
    }
    public void fetch_desc()
    {
        ...
        SqlCommand cmd = new SqlCommand("select n.*, s.Stud_Fname, s.Stud_Lname from Notice as n inner join student as s on s.Enrollment_no = n.Enrollment_no where Notice_ID = '" + MessageID + "' and n.Enrollment_no is not null", con);
