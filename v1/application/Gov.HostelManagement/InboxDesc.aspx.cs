...
public partial class _Default : System.Web.UI.Page
{
    ...
    public void fetch_desc()
    {
        ...
        SqlCommand cmd = new SqlCommand("select * from Notice where Notice_ID = '" + NoticeID + "' and Enrollment_no = '"+Enrollno+"'", con);
