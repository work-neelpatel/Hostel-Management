<%@ Page Title="" Language="C#" MasterPageFile="StudentMaster.master" AutoEventWireup="true" CodeFile="NoticeBox.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="slidebar" Runat="Server">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="NoticeBox.aspx">
...
<form id="form" Runat="Server">
        <div class="container-fluid">
          ...
          <p class="pt-4 text-dark text-center" runat="server" id="empty_box">No Notice from Hostel.</p>
