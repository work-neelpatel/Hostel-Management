...
public partial class _Default : System.Web.UI.Page
{
    ...
    public void load_notification()
    {
        int i=0;
        con.Open();
        SqlCommand cmd = new SqlCommand("select c.*, s.Stud_Fname, s.Stud_Lname from Complains as c inner join Student as s on c.Enrollment_no = s.Enrollment_no order by Date desc", con);
        ...
        for (i = 0; dr.Read(); i++)
        {
            ...
            lt1.Text = "Subject : " + dr["Comp_Type"].ToString() + " </br>Student : " + dr["Stud_Fname"].ToString() + " " + dr["Stud_Lname"].ToString() + "";
            ...
            if (day < 1)
            {
                ...
                if (hour < 1)
                {
                    ...
                    lt2.Text += "<span class='time'>" + min + " Minute ago" + "</span>";
                }
                else
    ...
    {
        Response.Redirect("HComplainDesc?Complain="+nid+"");
    }
