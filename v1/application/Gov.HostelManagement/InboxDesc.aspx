<%@ Page Title="" Language="C#" MasterPageFile="StudentMaster.master" AutoEventWireup="true" CodeFile="InboxDesc.aspx.cs" Inherits="_Default" %>
              ...
              <div class="card shadow mb-4 border-left-info">
                ...
                <div class="mb-3 text-secondary text-left">
                  ...
                  <div class="pt-3 text-left">
                            <a href="Inbox" class="text-decoration-none text-info">&larr; Go Back </a>
                    </div>
                  </div>
              </div>
            </div>
