...
public partial class Default2 : System.Web.UI.Page
{
    ...
    public void load_notification()
    {
        int i;
        con.Open();
        SqlCommand cmd = new SqlCommand("select n.*, s.Stud_Fname, s.Stud_Lname from Notice as n inner join student as s on s.Enrollment_no = n.Enrollment_no where n.Enrollment_No is not null order by Notice_Date desc", con);
        SqlDataReader dr = cmd.ExecuteReader();
        for (i = 0; dr.Read(); i++)
        {
            //div1
            HtmlGenericControl div1 = new HtmlGenericControl("div");
            div1.Attributes["class"] = "card shadow mb-4 border-left-info";
            MessageBox.Controls.Add(div1);
            ...
            //Subject - Lable 
            Label lt1 = new Label();
            lt1.Attributes["class"] = "m-0 p-0 col-10 font-weight-bold text-info";
            lt1.Text = "Subject : " + dr["Notice_Subject"].ToString()+ " </br>Student : " + dr["Stud_Fname"].ToString() + " "+ dr["Stud_Lname"].ToString()+"";

            //Time - Lable
            Label lt2 = new Label();
            lt2.Attributes["class"] = "m-0 p-0 fo pt-1";
            //lt2.Text = "Subject : " + dr["Notice_Subjet"].ToString();
    ...
    {
        Response.Redirect("MessageBoxDesc?Message=" + nid + "");
    }
