<%@ Page Title="" Language="C#" MasterPageFile="StudentMaster.master" AutoEventWireup="true" CodeFile="RequestDesc.aspx.cs" Inherits="_Default" %>
            ...
            <div class="col-xl-8 mb-4">
              <div class="card shadow mb-4 border-left-warning">
                ...
                <div class="card-body">
                        ...
                        <div id="RHResult" runat="server">
                            <div class="mb-2 font-weight-bold text-secondary text-center border-bottom pt-3">
                                <asp:Label ID="Label4" runat="server" Text="Room Holder Response" ></asp:Label>
                            </div>
                         ...
                         <div class="pt-2 text-center" id="Result2_lbls" runat="server">
                          <asp:Label ID="accept" runat="server" Text="Request Accepted" class="mb-4 text-success text-center"></asp:Label>
                          <asp:Label ID="denied" runat="server" Text="Request Denied" class="mb-4 text-danger text-center"></asp:Label>
                 ...
                 <div id="Result" runat="server">
                    <div class="mb-2 font-weight-bold text-secondary text-center border-bottom pt-3">
                     ...
                     <div class="pt-2 text-center">
                      <asp:Label ID="accept2" runat="server" Text="Request Accepted" class="mb-4 text-success text-center"></asp:Label>
                      <asp:Label ID="denied2" runat="server" Text="Request Denied" class="mb-4 text-danger text-center"></asp:Label>
                      <asp:Label ID="pending2" runat="server" Text="Result Pending.." class="mb-4 text-secondary text-center"></asp:Label>
                     </div>
                 </div>

                  <div class="pt-4">
                      <a href="RequestBox" class="text-decoration-none text-warning">&larr; Go Back </a>
                  </div>
