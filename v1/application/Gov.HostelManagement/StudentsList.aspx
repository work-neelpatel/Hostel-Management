<%@ Page Title="" Language="C#" MasterPageFile="HostelMaster.master" AutoEventWireup="true" CodeFile="StudentsList.aspx.cs" Inherits="Default2" ValidateRequest="false"%>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Allocated Seats</title>
...
<form id=form runat="server">
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Allocated Seats</h1>
            <p class="mt-2"><a href="StudentsList" class="mr-4 text-info text-decoration-none" style="border-bottom:1px solid">Allocated Seats</a><a href="UStudentsList" class="text-secondary text-decoration-none">Requested Seats</a></p>
          </div>
          <div class="form-inline">
              <div class="col-xl-8 text-left form-inline">
                  <p class="text-info mr-4">Allocated Seats <label runat="server" id="allocated_seats" class="text-dark"></label></p>
                  <p class="text-info mr-4">Empty Seats <label runat="server" id="empty_seats" class="text-dark"></label></p>
                  <p class="text-info">Total Seats <label runat="server" id="total_seats" class="text-dark"></label></p>
              </div>
              <div class="text-right col-xl-4 mb-4 pr-4">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="form-inline font-weight-bold text-info">
                    <p class="col-xl-2 pl-2">Gender</p>
