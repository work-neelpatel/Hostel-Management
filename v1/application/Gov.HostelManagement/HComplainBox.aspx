<%@ Page Title="" Language="C#" MasterPageFile="HostelMaster.master" AutoEventWireup="true" CodeFile="HComplainBox.aspx.cs" Inherits="_Default" %>
...
<form id="form" Runat="Server">
        <div class="container-fluid">
          ...
          <p class="pt-4 text-dark text-center" runat="server" id="empty_box">No Complains from Students.</p>
