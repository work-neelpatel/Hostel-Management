...
public partial class _Default : System.Web.UI.Page
{
    ...
    string cdate, ctime, subject, Enrollment_No;
    ...
    public void load_updatereq()
    {
        int i = 0;
        con.Open();
        SqlCommand cmd = new SqlCommand("select u.*,s.Stud_Fname,s.Stud_Lname from Update_Data u inner join Student s on s.Enrollment_No=u.Enrollment_No where (u.Enrollment_No = '"+Enrollment_No+"' or u.Req_Enrollment_No = '"+Enrollment_No+"') order by u.Date desc", con);
    ...
    {
        Response.Redirect("RequestDesc?Request=" + rid + "");
    }
}